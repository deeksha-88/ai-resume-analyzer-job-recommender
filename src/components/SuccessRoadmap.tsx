  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold text-foreground mb-3">Success Roadmap</h2>
          <p className="text-muted-foreground">Your personalized learning path to close skill gaps</p>
        </motion.div>
              ...
              >
                ...
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="font-semibold text-foreground">{step.skill}</h3>
                  </div>
